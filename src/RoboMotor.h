...
// =============================================================================
    ...
    #define ROBOMOTOR_PLATFORM_NRF53_GENERIC
#elif defined(ROBOSERVO_PLATFORM_RENESAS)
    #define ROBOMOTOR_PLATFORM_RENESAS
#elif defined(ROBOSERVO_PLATFORM_MBED)
    #define ROBOMOTOR_PLATFORM_MBED
#elif defined(ROBOSERVO_PLATFORM_ZEPHYR)
    #define ROBOMOTOR_PLATFORM_ZEPHYR
